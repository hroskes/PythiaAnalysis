...
LHE_DecayProbabilities_SpinZero_JHUGen = [
   ...
   "Name:SampleHypothesisJHUGen Alias:<Name> Process:SelfDefine_spin0 Production:ZZGG MatrixElement:JHUGen Couplings:ghg2=1,0;ghz1=1,0;ghzgs2=0.0477547,0 Cluster:NoInitialQ isGen:1 NoBranch:1",
